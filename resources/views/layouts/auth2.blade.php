...
<body>
    ...
    <div class="container-fluid">
        <div class="row eq-height-row">
            ...
            <div class=" col-lg-2 col-md-2 col-ms-2 col-xs-2"></div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 right-col eq-height-col">
                <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-ms-2"></div>
        </div>
    </div>
